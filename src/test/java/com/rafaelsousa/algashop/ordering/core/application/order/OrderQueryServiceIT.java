...
class OrderQueryServiceIT extends AbstractApplicationIT {
    ...
    @Autowired
    OrderQueryServiceIT(ForQueryingOrders orderQueryService, Orders orders, Customers customers) {
    ...
    @Test
    @WithMockJwt(role = "", audiences = "machine-client-web", subject = "machine-client-web")
    void shouldOrderByStatus() {
        ...
        assertThat(page.getContent().getLast().getStatus()).isEqualTo(OrderStatus.READY.toString());
    }
}